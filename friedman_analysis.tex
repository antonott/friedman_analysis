...
\begin{solution}
  ...
  Finally, assume that $f$ is integrable. There is a Cauchy in the mean sequence $(f_n)$ of integrable simple functions converging to $f$ a.e. The sequence $(|f_n|)$ consists of integral simple functions. It is Cauchy in the mean since
  \begin{equation*}
    ||f_n| - |f_m|| \le |f_n - f_m|,
  \end{equation*}
