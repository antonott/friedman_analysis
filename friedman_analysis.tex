...
\begin{solution}
  ...
  \begin{equation*}
    |f_m - f_n| \le |f_m - f| + |f_n - f| < \epsilon
  \end{equation*}
  whenever $m,n \ge N$, and
  \begin{equation*}
    \int |f_m - f_n| d\mu \le \epsilon \mu(X).
  \end{equation*}
  It follows that the sequence $(f_n)$ is Cauchy in the mean, hence that $f$ is integrable and $\int f d\mu = \lim_n \int f_n d\mu$ by Theorem 2.8.2
